...
class SugarWidgetSubPanelTopCreateTilkFromLead extends SugarWidgetSubPanelTopButton
{
	function SugarWidgetSubPanelTopCreateTilkFromLead($module='', $title='', $access_key='', $form_value='')
	{
            global $app_strings;
	...
	function display(&$widget_data)
	{
            ...
            $button .= '<input type="hidden" name="action" value="EditView"/>
                                    ...
                                    <input type="hidden" name="CreateFromLead" value="true" />
                                    </form>';
