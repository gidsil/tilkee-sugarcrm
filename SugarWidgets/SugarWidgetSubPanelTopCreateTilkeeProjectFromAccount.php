...
class SugarWidgetSubPanelTopCreateTilkeeProjectFromAccount extends SugarWidgetSubPanelTopButton
{
	function SugarWidgetSubPanelTopCreateTilkeeProjectFromAccount($module='', $title='', $access_key='', $form_value='')
	{
            global $app_strings;
	...
	function display(&$widget_data)
	{
            ...
            $button .= '<input type="hidden" name="action" value="EditView"/>
                                    ...
                                    <input type="hidden" name="CreateFromAcc" value="true" />
                                    </form>';
