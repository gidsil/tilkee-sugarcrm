...
class SugarWidgetSubPanelTopCreateTilkFromProject extends SugarWidgetSubPanelTopButton
{
	...
	function display(&$widget_data)
	{
            ...
            $button .= '<input type="hidden" name="action" value="EditView"/>
                                    ...
                                    <input type="hidden" name="return_module" value="TILKEE_PROJECTS"/>
                                    <input type="hidden" name="return_action" value="DetailView" />
                                    <input type="hidden" name="CreateFromProject" value="true" />
                                    </form>';
