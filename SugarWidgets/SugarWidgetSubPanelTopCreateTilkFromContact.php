...
class SugarWidgetSubPanelTopCreateTilkFromContact extends SugarWidgetSubPanelTopButton
{
	function SugarWidgetSubPanelTopCreateTilkFromContact($module='', $title='', $access_key='', $form_value='')
	{
            global $app_strings;
	...
	function display(&$widget_data)
	{
            ...
            $button .= '<input type="hidden" name="action" value="EditView"/>
                                    <input type="hidden" name="module" value="TILKEE_TILKS"/>
                                    ...
                                    <input type="hidden" name="CreateFromContact" value="true" />
                                    </form>';
